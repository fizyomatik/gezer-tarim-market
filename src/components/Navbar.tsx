  ...
  return <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur">
    <div className="mx-auto flex min-h-20 max-w-7xl flex-wrap items-center justify-between gap-3 px-5 py-2 lg:px-8">
      ...
      <div className="flex items-center gap-3">
        {isAdmin ? <Link href="/admin" title={userName || userEmail} className="rounded-lg bg-[#174d32] px-3 py-2 text-sm font-bold text-white">Yönetim</Link> : <Link href="/login" className="rounded-lg bg-[#174d32] px-3 py-2 text-sm font-bold text-white">Yönetici girişi</Link>}
